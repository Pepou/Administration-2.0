...
#        print(f"list Tlue {list_Tlue} et residu {residu} ")
        ...
        try:
            ...
            normalite = "Warning : Evaluation impossible."
...
#        print(f"list _ Tlue {list_Tlue} \n list residu {list_residu} \n ecarttype {ecartype_residu}")
        self.graphicsView_2.clear()
        try:
            list_residus_normalises = [(x/ecartype_residu) for x in list_residu]
        except RuntimeWarning:
            list_residus_normalises = [0 for x in list_residu]
